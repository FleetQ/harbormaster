...
def register_routes(
    ...
    *,
    ...
    # v24.0.0a4: Budget UI surface extracted to
    # ``harbormaster.ui.routes_budgets``. 5 endpoints (hosts, tools,
    # projects-by-host triad, per-project GET + PUT) + their TOML
    # writer helpers. Shared `_toml_value` helper moved to
    # ``harbormaster.ui._toml_helpers`` (used by accent picker below).
    from harbormaster.ui.routes_budgets import register_budget_routes
    register_budget_routes(app, config)
